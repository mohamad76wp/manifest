...
import configparser
import re
from okex_requests import place_conditional_pos
...
async def raw(client, update, users, chats):
    try:
        ...
        if test_char in message:
            ...
            make_position = place_conditional_pos(price_dict["side"], "1", price_dict["Secure TP"], price_dict["SL"],price_dict["Max TP"])
